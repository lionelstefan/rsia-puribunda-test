...
@section('header_page', 'Edit Jabatan')

@section('content')

    <form method="POST" enctype="multipart/form-data" class="mt-4" id="edit-jabatan-form" name="edit-jabatan-form">
        @csrf
        ...
        <div class="row form-group mb-2">
            <label for="title" class="col-sm-2 col-form-label fw-normal">Nama Jabatan <span class="text-danger">
                    *</span></label>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.edit').click(function(e) {
                ...
                var form_data = new FormData($('#edit-jabatan-form')[0]);
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            contentType: false,
                            processData: false,
                            url: '{{ route('jabatan.confirm-edit') }}',
                            data: form_data,
