@extends ('master')
@section('title_page', 'Edit Event')
@section('header_page', 'Edit Event')

@section('content')

    <form method="POST" enctype="multipart/form-data" class="mt-4" id="edit-event-form" name="edit-event-form">
        @csrf
        <div class="alert alert-danger print-error-msg" style="display:none">
            <ul></ul>
        </div>
        <input type="hidden" id="id_event" name="id_event" value="{{ $dataEvent['id_event'] }}">
        <div class="row form-group mb-2">
            ...
            <div class="col-sm-6 col-12">
                <input class="form-control form-control-sm" type="text" name="title" id="title"
                    value="{{ $dataEvent['title'] }}" required>
            </div>
        </div>
        ...
        <div class="row form-group mb-2">
            <div class="input-group mb-3">
                <label for="venue_location" class="col-sm-2 col-form-label fw-normal">Venue <span class="text-danger">
                        *</span></label>
                <div class="col-sm-6 col-12">
                    <select name="venue_location" id="venue_location" class="form-control" style="margin-left:5px;">
            ...
            <div class="col-md-3 col-6">
                <div class="col-sm-12">
                    <input class="form-control form-control-sm" type="text" name="sDate" id="sDate"
                        value="{{ $dataEvent['sDate'] }}" required />
                </div>
            </div>
            <div class="col-md-3 col-6">
                <div class="input-group mb-3">
                    <div class="col-sm-6 col-8">
                        <input class="form-control form-control-sm" type="text" name="sTime" id="sTime"
                            value="{{ $dataEvent['sTime'] }}" required />
                    </div>
            ...
            <div class="col-md-3 col-6">
                <div class="col-sm-12">
                    <input class="form-control form-control-sm" type="text" name="eDate" id="eDate"
                        value="{{ $dataEvent['eDate'] }}" required />
                </div>
            </div>
            <div class="col-md-3 col-6">
                <div class="input-group mb-3">
                    <div class="col-sm-6 col-8">
                        <input class="form-control form-control-sm" type="text" name="eTime" id="eTime"
                            value="{{ $dataEvent['eTime'] }}" required />
                    </div>
                    <span class="input-group-text"><i class="fa-regular fa-clock"></i></span>
                </div>
            </div>
        ...
        <div class="row form-group mb-2">
            <label for="title" class="col-sm-2 col-form-label fw-normal">Description <span class="text-danger">
                    *</span></label>
            <div class="col-sm-6 col-12">
                <textarea class="form-control form-control-sm" name="desc" id="desc" required>{{ $dataEvent['desc'] }}</textarea>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.edit').click(function(e) {
                ...
                var form_data = new FormData($('#edit-event-form')[0]);
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            contentType: false,
                            processData: false,
                            url: '{{ route('requestEditEvent.post') }}',
                            data: form_data,
