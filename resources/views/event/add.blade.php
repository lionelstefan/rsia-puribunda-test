@extends('master')
@section('title_page', 'AddEvent')
@section('header_page', 'Create Event')
@section('content')

    <form enctype="multipart/form-data" id="add-event-form" name="add-event-form" class="mt-4">
        @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.add').click(function(e) {
                ...
                var form_data = new FormData($('#add-event-form')[0]);
