...
<body style="background-color: black">
    <div class="container">           
        <form enctype="multipart/form-data" id="get-point-form" name="get-point-form" class="mt-2">
            @csrf
            ...
            <div class="mb-2">
                ...
                <button id="scan-qr" class="btn btn-success btn-sm" style="float: right;">
                    <i class="fa-solid fa-expand fa-xl"></i> Scan QR Member</button>
            </div>
            ...
            <div class="row form-group mb-2">
                <label for="title" class="col-sm-2 col-form-label fw-normal" style="color:#FFD700">Member Id<span
            ...
            <div class="row form-group mb-2">
                <label for="title" class="col-sm-2 col-form-label fw-normal" style="color:#FFD700">Current Point Member <span
                        class="text-danger"> *</span></label>
                <div class="col-sm-6 col-xs-12">
                    <input class="form-control form-control-sm bg-secondary text-warning border border-warning"
            ...
            <div class="row form-group mb-2">
                <label for="title" class="col-sm-2 col-form-label fw-normal" style="color:#FFD700">Bill Number <span
                        class="text-danger"> *</span></label>
                <div class="col-sm-6 col-xs-12">
            ...
            <div class="row form-group mb-2">
                <label for="title" class="col-sm-2 col-form-label fw-normal" style="color:#FFD700">Total Bill <span
                        class="text-danger"> *</span></label>
                <div class="col-sm-6 col-xs-12">
                    <input class="form-control form-control-sm bg-dark text-warning border border-warning"
                ...
                <div class="col-sm-6 col-xs-12 mt-2">                    
                    <button id="calculate_button" name="calculate_button" type="button" class="btn btn-primary btn-sm" onclick="calculateTotalGetPoint()" disabled><i class="fa-solid fa-calculator"></i> Calculate Point</button>
                </div>
            </div>

            <div class="row form-group mb-2">
                <label for="title" class="col-sm-2 col-form-label fw-normal" style="color:#FFD700">Total Get Point<span
                    class="text-danger"> *</span></label>
                <div class="col-sm-6 col-xs-12">
                    <input class="form-control form-control-sm bg-secondary text-warning border border-warning"
                        type="text" name="total_get_point" id="total_get_point" readonly="readonly" required>
                </div>
            </div>
...
//AUTO FORMAT CURRENCY
    ...
    //enable disable button calculate    
    var fields = "#member_id, #current_point_member, #bill_number, #total_bill";
    ...
    //end of enable disable button calculate
    

    function calculateTotalGetPoint() {        
        $('#total_get_point').empty();   
        var totalBill = $('#total_bill').val();        
        let formatBill = totalBill.replace(/\,/g, '');        
        let totalPoint = formatBill / 10000;              
        let totalFormatPoint = totalPoint.toString().split('.')[0];        

        //var div = document.getElementById('grand_total');        
        //div.innerHTML += totalFormatPoint;
        $('#total_get_point').val(totalFormatPoint);
    }
    ...
    $('.add').click(function(e) {
        ...
        var form_data = new FormData($('#get-point-form')[0]);
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    contentType: false,
                    processData: false,
                    url: '{{ route('requestGetPoint.post') }}',
                    data: form_data,
    ...
    {   
        ...
        $.ajax({
                type: 'POST',
                dataType:'json',
                url: '{{ route('checkMembersExist.post') }}',
                data: {'id': member_id},
                async: false,
                success: function(response) {                                                      
