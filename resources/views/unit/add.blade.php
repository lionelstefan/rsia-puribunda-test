...
@section('header_page', 'Create Unit')
@section('content')

    <form enctype="multipart/form-data" id="add-unit-form" name="add-unit-form" class="mt-4">
        @csrf
        <div class="alert alert-danger print-error-msg" style="display:none">
            <ul></ul>
        </div>
        <div class="row form-group mb-2">
            <label for="title" class="col-sm-2 col-form-label fw-normal">Nama Unit <span class="text-danger"> *</span></label>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.add').click(function(e) {
                ...
                var form_data = new FormData($('#add-unit-form')[0]);
